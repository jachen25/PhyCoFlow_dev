...
def build_gl_enh_model(args, train_set, device):
    ...
    backbone = tpf.ConditionalPointHybridLocalGlobalRBF(
        ...
        fieldwise_rbf_gather=getattr(args, "fieldwise_rbf_gather", False),
        rbf_sigma_per_field=getattr(args, "rbf_sigma_per_field", None),
        periodic_coord_periods=getattr(args, "periodic_coord_periods", None),
